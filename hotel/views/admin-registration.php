            ...
            <div class="row">
                <div class="card w-50 mx-auto border-0">
                    <div class="card-header bg-white border-0">
                        <p class="h2 text-success text-center mt-2 fw-bold" style="font-family:serif"><i class="fa-solid fa-user-plus"></i> CREATE ADMIN ACCOUNT</p>
                        <p class="fs-6 text-success text-center mt-2" style="font-family:serif">FOR ADMIN USERS ONLY</p>
                    </div>

                    <div class="card-body">
                        <form action="../actions/admin-registration.php" method="post" class="w-75 mx-auto">
                            <div class="row g-2">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-8">
                                    <input type="password" name="password" placeholder="PASSWORD" class="form-control mb-3" style="font-family:serif">
                                </div>
                            </div>
                            <div class="row g-2">
                                <div class="col-md-8 offset-md-3">
                                    <button type="submit" class="btn btn-success w-100 mb-3" style="font-family:serif">Register</button>
                                <div>
                            <div>
                        </form>

                        <div class="text-center mt-3">
                            <p class="small" style="font-family:serif">Already have an account? <a href="../views/admin-login.php">Log In</a></p>
                        </div>
                    </div>
                </div>
            </div>
