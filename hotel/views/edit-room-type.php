            ...
            <div class="row">
                <div class="card mx-auto w-50 border-0" style="font-family:serif">
                    <div class="card-header bg-white border-0">
                        <p class="h1 text-warning text-center mt-2 fw-bold"><i class="fa-solid fa-pen-to-square"></i> EDIT ROOM TYPE</p>
                    </div>
                    
                    <div class="card-body">
                        <img src="../assets/room/<?= $room_details['room_pic'] ?>" alt="Room Picture" class="card-img-top">
                                    <div class="card-body">
                                        <form action="../actions/upload-photo.php?hotel_id=<?= $room_details['id'] ?>" method="post" enctype="multipart/form-data">
                                            <div class="input-group input-group-md">
                                                <input type="file" name="room_pic" id="room_pic" class="form-control" accept="image/*" required>
                                                <button type="submit" class="btn btn-outline-warning"><i class="fas fa-arrow-circle-up"></i></button>
                                            </div>
                                        </form>
                                    </div>

                        <form action="../actions/edit-room-type.php" method="post">
                            <div class="row">
                                <input type="hidden" name="room_id" value="<?= $room_details['id'] ?>">

                                <label for="room_type" class="form-label text-dark mt-2">ROOM TYPE</label>
                                <input type="text" name="room_type" id="room_type" class="form-control mb-3 ms-2" value="<?= $room_details['room_type']?>" required>

                                <label for="room_size" class="form-label text-dark">ROOM SIZE</label>
                                    <div class="input-group mb-3 w-50">
                                        <input type="number" name="room_size" id="room_size" class="form-control" aria-label="Room Size" aria-describedby="sqft" value="<?= $room_details['room_size']?>" required>
                                    ...
                                    <input type="number" name="num_bed" id="num_bed" class="form-control mb-3 ms-2 w-50" value="<?= $room_details['num_bed']?>" required>
                                    ...
                                    <div class="input-group mb-3 w-50">
                                        ...
                                        <input type="number" name="num_guest" id="num_guest" class="form-control" aria-label="Number of Guest" aria-describedby="max" value="<?= $room_details['num_guest']?>" required>
                                    </div>
                                    ...
                                    <div class="input-group mb-5 w-50">
                                        ...
                                        <input type="number" name="room_price" id="room_price"  class="form-control" aria-label="Room Price" aria-describedby="jpy" value="<?= $room_details['room_price']?>" required>
                                    </div>

                                    <button type="submit" name="btn_edit" class="btn btn-warning w-100 mb-5">Edit</button>
