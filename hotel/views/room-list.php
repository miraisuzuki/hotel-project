        ...
        ?>
            <div class="row gx-4 gx-lg-5 align-items-center pb-5">
                ...
                <div class="col-6">
                    ...
                    <a href="personal-info.php?hotel_id=<?= $room_details['id'] ?>"><button class="btn btn-outline-success flex-shrink-0 btn-sm mb-2" type="button" style="font-family:serif">SELECT THIS ROOM</button></a>
